...
export default class Schema {
  ...
  public constructor() {
    ...
    invariant(constructorAllowed, "You must call Schema.get(), not new Schema");
  }
  ...
  getModelTypeName() {
    return stripSuffix(this.constructor.name, "Schema").expect(
      'Schema names must end in "Schema"'
    );
  }
